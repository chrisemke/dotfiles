(define-module (config)
	...
	#:autoload (gnu services base) (guix-configuration guix-extension guix-service-type udev-rule udev-rules-service)
	#:autoload (gnu services containers) (rootless-podman-service-type rootless-podman-configuration)
	#:autoload (gnu services desktop) (%desktop-services plasma-desktop-service-type bluetooth-service-type)
	#:autoload (gnu services linux) (zram-device-service-type zram-device-configuration)
	#:autoload (gnu services networking) (nftables-service-type)
	...
	#:autoload (gnu system) (%base-packages %default-kernel-arguments operating-system)
	...
	#:autoload (nongnu packages linux) (linux-7.2 linux-firmware)
